...
function rDash(){
  ...
  return'<div class="ps act"><div class="pg-head"><h1 class="pg-title">'+g+', Alex</h1><p class="pg-desc">You have <strong>'+ao+' active offers</strong> and <strong>'+nr+' new users</strong> this month to review.</p></div>'+
