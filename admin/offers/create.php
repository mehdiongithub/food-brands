...
<head>
    ...
    <title>FoodScope — Add Offer</title>
...
<body>
    ...
    <div id="main">
        <div class="pg-content" id="pgC">
            ...
            <div class="pg-head" style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:12px;">
                <div>
                    <h1 class="pg-title">Add Offer</h1>
                    <p class="pg-desc">Create a new brand offer</p>
                </div>
    ...
    <script>
        ...
        $('#addCountryBtn').on('click', function () {
            ...
            // Reset dropdown back to placeholder after adding
            $sel.val('');
        });

        // --- Load brands + countries via the common endpoint ---
        $(function () {
            $.ajax({
        ...
        $('#addOfferForm').on('submit', function (e) {
            ...
            .done(function (res) {
                if (res.success) {
                    toast(res.message || 'Offer created successfully', 'suc');
                    setTimeout(function () {
            ...
            .always(function () {
                $btn.prop('disabled', false).html('<i class="fas fa-save"></i> Create Offer');
            });
        });
    </script>
</body>
