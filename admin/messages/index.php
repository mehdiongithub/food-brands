...
<head>
    ...
    <title>FoodScope — Contact Messages</title>
            ...
            <div class="ps act">
                <div class="pg-head" style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:12px;">
                    <div>
                        ...
                        <p class="pg-desc">Messages submitted through the website's contact form</p>
                    </div>
                </div>
                ...
                <div class="lt">
                    ...
                    <div class="lt-r">
                        <div class="ls">
                            ...
                            <input type="text" id="customSearch" placeholder="Search messages...">
                        </div>
                ...
                <div class="cd">
                    <div class="cd-b p-3">
                        <div class="tw">
                            <table id="messagesTable" class="at display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Email</th>
    ...
    <script>
        ...
        $(function() {
            table = $('#messagesTable').DataTable({
                ...
                buttons: [{
                    ...
                    className: 'ba',
                    filename: 'contact_messages_export_' + new Date().toISOString().slice(0, 10),
        ...
        function deleteMessage(id, name) {
            ...
            $('#deleteModalText').text(
                name ? 'Delete the message from "' + name + '"? This cannot be undone.' : 'This message will be permanently deleted. This cannot be undone.'
            );
            deleteModal.show();
        }
