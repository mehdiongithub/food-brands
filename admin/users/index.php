...
<head>
    ...
    <title>MenuCrest — Admin Users</title>
...
<body>
            ...
            <div class="ps act">
                <div class="pg-head" style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:12px;">
                    <div>
                        ...
                        <p class="pg-desc">Manage user accounts and permissions</p>
                    </div>

                    <a href="<?= BASE_URL ?>/admin/users/create.php" class="ba text-decoration-none">
                ...
                <div class="cd">
                    <div class="cd-b p-3">
                        <div class="tw">
                            <table id="usersTable" class="at display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>User</th>
                                        <th>Role</th>
    ...
    <script>
        ...
        var table; // keep reference accessible to deleteUser()
        ...
        function deleteUser(id, name) {
            ...
            $('#deleteModalText').text(
                name ? 'Delete "' + name + '"? This cannot be undone.' : 'This user will be permanently deleted. This cannot be undone.'
            );
            deleteModal.show();
        }
        ...
        $('#confirmDeleteBtn').on('click', function() {
            ...
            .done(function(res) {
                deleteModal.hide();
                if (res.success) {
                    toast(res.message || 'User deleted successfully', 'suc');
                    table.ajax.reload(null, false); // reload table, keep current page
                } else {
                    toast(res.message || 'Failed to delete user', 'err');
                }
            })
            .fail(function() {
                deleteModal.hide();
