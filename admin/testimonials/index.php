...
<head>
    ...
    <title>MenuCrest — Admin Testimonials</title>
    ...
    <style>
        .stars-wrap i { font-size: 0.85rem; margin-right: 1px; }
    </style>
</head>
        ...
        <div class="pg-content" id="pgC">
            ...
            <div class="ps act">
                <div class="pg-head" style="display:flex; justify-content:space-between; align-items:flex-start; flex-wrap:wrap; gap:12px;">
                    <div>
                        <h1 class="pg-title">Testimonials</h1>
                        <p class="pg-desc">Manage customer testimonials and reviews</p>
                    </div>
                    <?php if ($isAdmin): ?>
                    <a href="<?= BASE_URL ?>/admin/testimonials/create.php" class="ba text-decoration-none">
                ...
                <div class="lt">
                    <div class="lt-l">
                        ...
                        <select class="fs" id="ratingFilter">
                    ...
                    <div class="lt-r">
                        <div class="ls">
                            ...
                            <input type="text" id="customSearch" placeholder="Search testimonials...">
                        </div>
                ...
                <div class="cd">
                    <div class="cd-b p-3">
                        <div class="tw">
                            <table id="testimonialsTable" class="at display" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Review</th>
            ...
            <div class="modal-content">
                <div class="modal-body text-center" style="padding:32px 28px;">
                    ...
                    <p style="color:var(--muted);margin-bottom:0;" id="deleteModalText">
                        This testimonial will be permanently deleted. This cannot be undone.
                    </p>
                </div>
    ...
    <script>
        ...
        $(function() {
            table = $('#testimonialsTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "../../api/testimonials/testimonials.php",
                    type: "POST",
                    data: function(d) {
                ...
                buttons: [{
                    ...
                    className: 'ba',
                    filename: 'testimonials_export_' + new Date().toISOString().slice(0, 10),
        ...
        function deleteTestimonial(id, name) {
            ...
            $('#deleteModalText').text(
                name ? 'Delete "' + name + '"? This cannot be undone.' : 'This testimonial will be permanently deleted. This cannot be undone.'
            );
            deleteModal.show();
        }
        ...
        $('#confirmDeleteBtn').on('click', function() {
            ...
            $.ajax({
                url: '../../api/testimonials/delete-testimonial.php',
                type: 'POST',
            ...
            .done(function(res) {
                deleteModal.hide();
                if (res.success) {
                    toast(res.message || 'Testimonial deleted successfully', 'suc');
                    table.ajax.reload(null, false);
                } else {
                    toast(res.message || 'Failed to delete testimonial', 'err');
                }
            })
            .fail(function() {
                deleteModal.hide();
